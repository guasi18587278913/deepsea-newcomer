...
| `diagnosis.html` | AI 刘小白 项目诊断（独立页） | `?from=welcome` 决定完成后回 welcome 还是 roadmap |
...
`assistant.js` 是**唯一**的跨页面脚本（"AI 刘小白"右下角浮窗）：
...
| Key | 写入方 | 读取方 | 内容 |
|-----|--------|--------|------|
| `ds_experience` | welcome | — | 零基础 / 有基础 / 有产品经验 |
| `ds_goal` | welcome | — | 做产品赚钱 / 提升技术 / 产品出海 |
| `ds_daily_minutes` | welcome | roadmap | 30 / 60 / 120 / 0 |
